  ...
  return (
    ...
    >
      <header className="text-center space-y-4">
        ...
        <h2 className="text-4xl font-black text-on-surface tracking-tight">{t("About Nusa Culinary")}</h2>
        <p className="text-on-surface-variant max-w-lg mx-auto">{t("Connecting you to the hidden gems of Indonesian cuisine, from the spice islands to the mountain peaks.")}</p>
      </header>
      ...
      <section className="p-8 bg-surface-container-low rounded-[2.5rem] text-on-surface overflow-hidden relative border border-outline-variant/10">
        <div className="relative z-10 space-y-6">
          <h3 className="text-3xl font-black tracking-tight">{t("Join the Movement")}</h3>
